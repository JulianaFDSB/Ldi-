...
class Estoque {
    ...
    private function __construct($idEstoque,$idProduto,$dtEntrada,$quantidade,$dtFabricacao,$dtVencimento,$nfCompra,$precoCompra,$icmCompra,$precoVenda,$qtdVendida,$qtdOcorrencia,$ocorrencia){
    ...
    public function getIcmCompra(){
        return $this->icmCompra;
    }

    public function setIcmCompra($icmCompra){
        $this->icmCompra = $icmCompra;
        return $this;
    }
